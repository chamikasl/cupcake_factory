//need to add empty cart command, some edits remain
...
import com.csl.cupcake_factory.Model.Cart;
import com.csl.cupcake_factory.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                txtTotalAmount.setText("Cart Total : Rs " + String.valueOf(overTotalPrice) + ".00");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("Shipped")) {
                        txtTotalAmount.setText(userName + " order is shipped successfully.");
